...
layout=html.Div(children=[
    dbc.Container([
        dbc.Row([
            ...
            dbc.Col([html.H1('Expenses', style={'font-size': '350%',
                                                 'text-align': 'center',
                                                 'color':'#A1C298',
                                                 'font-weight': 'heavy',
                                                 'margin-top': '2em',
       ...
       dbc.Row([html.Img(src="assets/4078197.png", style={"max-width": "7%",'margin-bottom': '1.5em','text-align':'center'})],justify='center') ,
        dbc.Row([
                    dbc.Col([
                        dcc.DatePickerRange(
                            id='date-pick-D',
        ...
        dbc.Row([
            dbc.Col([
                dcc.Loading(dcc.Graph(id='Bar_Chart_D'),color='#501B1D',type='cube')
            ])
        ],style=Style_Row2),
        dbc.Row([
            dbc.Col([
                dcc.Loading(dcc.Graph(id='Pie_Chart_D'), color='#501B1D', type='cube')
            ])
        ],style=Style_Row2),
